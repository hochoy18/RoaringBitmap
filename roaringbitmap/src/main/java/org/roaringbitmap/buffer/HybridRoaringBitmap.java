...
/////////////
// TODO: throw an exception whenever one tries to modify a container
// that fails isArrayBacked() == true
/////////////
/**
 * 
 * NOTE: This is a prototype. Untested.
 * 
 * HybridRoaringBitmap is a compromise between a MutableRoaringBitmap
 * and an ImmutableRoaringBitmap, where only some of the containers
 * are immutable, while others are mutable.
 * 
 * You can create a HybridRoaringBitmap from an ImmutableRoaringBitmap,
 * and initially the two will share the same containers (that is, 
 * the content of the containers will off-heap). 
 * 
 * <pre>
 * {@code
 ...
 *      //...
 *
 *      ImmutableRoaringBitmap r = ...
 *      HybridRoaringBitmap hr = new HybridRoaringBitmap(r);
 * }
 * </pre>
 *
 *
 ...
 */
public class HybridRoaringBitmap extends ImmutableRoaringBitmap
   ...
   * @return new bitmap
   */
  public static HybridRoaringBitmap add(HybridRoaringBitmap rb, final long rangeStart,
      final long rangeEnd) {
    ...
    HybridRoaringBitmap answer = new HybridRoaringBitmap();
    ...
    if (hbStart == hbLast) {
      ...
      // throw an exception if the container is not mutable
      if(!c.isArrayBacked()) throw new RuntimeException("Immutable container!");
    ...
    {
    	  // TODO: throw an exception if the array is not mutable
   ...
   */
  @Deprecated
  public static HybridRoaringBitmap add(HybridRoaringBitmap rb,
   ...
   */
  public static HybridRoaringBitmap and(final HybridRoaringBitmap x1,
      final HybridRoaringBitmap x2) {
    final HybridRoaringBitmap answer = new HybridRoaringBitmap();
    int pos1 = 0, pos2 = 0;
   ...
   * @return result of the operation
   */
  public static HybridRoaringBitmap andNot(final HybridRoaringBitmap x1,
      final HybridRoaringBitmap x2) {
    final HybridRoaringBitmap answer = new HybridRoaringBitmap();
    int pos1 = 0, pos2 = 0;
    final int length1 = x1.highLowContainer.size(), length2 = x2.highLowContainer.size();
  ...
  public void add(final int... dat) {
    ...
    if(j < dat.length) {
      ...
      if (currentcontainerindex >= 0) {
	    ...
	    // TODO: throw an exception if the array is not mutable
        if(!currentcont.isArrayBacked()) throw new RuntimeException("immutable container");
   ...
   * @return a new bitmap
   */
  public static HybridRoaringBitmap bitmapOf(final int... dat) {
    final HybridRoaringBitmap ans = new HybridRoaringBitmap();
    ans.add(dat);
    return ans;
  }
   ...
   * @return a new Bitmap
   */
  public static HybridRoaringBitmap flip(HybridRoaringBitmap bm, final long rangeStart,
      final long rangeEnd) {
    rangeSanityCheck(rangeStart, rangeEnd);
    if (rangeStart >= rangeEnd) {
      return bm.clone();
   ...
   */
  @Deprecated
  public static HybridRoaringBitmap flip(HybridRoaringBitmap rb,
                                            final int rangeStart, final int rangeEnd) {
    if (rangeStart >= 0) {
  ...
  protected static HybridRoaringBitmap lazyorfromlazyinputs(final HybridRoaringBitmap x1,
      final HybridRoaringBitmap x2) {
    final HybridRoaringBitmap answer = new HybridRoaringBitmap();
   ...
   * @return result of the operation
   */
  public static HybridRoaringBitmap or(final HybridRoaringBitmap x1,
      final HybridRoaringBitmap x2) {
    final HybridRoaringBitmap answer = new HybridRoaringBitmap();
    int pos1 = 0, pos2 = 0;
    final int length1 = x1.highLowContainer.size(), length2 = x2.highLowContainer.size();
   ...
   * @return new bitmap
   */
  public static HybridRoaringBitmap remove(HybridRoaringBitmap rb, final long rangeStart,
      final long rangeEnd) {
    rangeSanityCheck(rangeStart, rangeEnd);
    if (rangeStart >= rangeEnd) {
      return rb.clone(); // empty range
   ...
   */
  @Deprecated
  public static HybridRoaringBitmap remove(HybridRoaringBitmap rb,
                                              final int rangeStart, final int rangeEnd) {
    if (rangeStart >= 0) {
   ...
   * @return result of the operation
   */
  public static HybridRoaringBitmap xor(final HybridRoaringBitmap x1,
      final HybridRoaringBitmap x2) {
    final HybridRoaringBitmap answer = new HybridRoaringBitmap();
    int pos1 = 0, pos2 = 0;
    final int length1 = x1.highLowContainer.size(), length2 = x2.highLowContainer.size();
   ...
   */
  public HybridRoaringBitmap(RoaringBitmap rb) {
    highLowContainer = new MutableRoaringArray();
   ...
   */
  public HybridRoaringBitmap(ImmutableRoaringBitmap irb) {
	    highLowContainer = new MutableRoaringArray();
    MappeableContainerPointer mcp = irb.highLowContainer.getContainerPointer();
    while (mcp.hasContainer()) {
    	((MutableRoaringArray) highLowContainer).append(mcp.key(), mcp.getContainer());
      mcp.advance();
    }
  }
 ...
 /**
  ...
  @Override
  public HybridRoaringBitmap clone() {
    final HybridRoaringBitmap x = (HybridRoaringBitmap) super.clone();
  ...
  public Iterator<Integer> iterator() {
    return new Iterator<Integer>() {
      ...
      public boolean hasNext() {
        return pos < HybridRoaringBitmap.this.highLowContainer.size();
      }

      private Iterator<Integer> init() {
        if (pos < HybridRoaringBitmap.this.highLowContainer.size()) {
          iter = HybridRoaringBitmap.this.highLowContainer.getContainerAtIndex(pos)
              .getShortIterator();
          hs = BufferUtil
              .toIntUnsigned(HybridRoaringBitmap.this.highLowContainer.getKeyAtIndex(pos)) << 16;
        }
        return this;
      }
