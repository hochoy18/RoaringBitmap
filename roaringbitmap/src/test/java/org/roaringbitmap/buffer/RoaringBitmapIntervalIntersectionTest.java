...
public class RoaringBitmapIntervalIntersectionTest {
  ...
  public static Object[][] params() {
    ...
    return new Object[][] {
            ...
            {testCase().withArrayAt(10, r).withBitmapAt(20, r).withRunAt(30, r)
                    .withRange(70000L, 150000L).build(), 70000L, 150000L},
            {testCase().withArrayAt(10, r).withBitmapAt(20, r).withRunAt(30, r)
                    .withRange(70000L, 150000L).build(), 71000L, 140000L},
            {testCase().withArrayAt(0, r).withBitmapAt(1, r).withRunAt(20, r).build(), 67000, 150000},
            {testCase().withBitmapAt(0, r).withArrayAt(1, r).withRunAt(20, r).build(), 67000, 150000},
            {testCase().withBitmapAt(0, r).withRunAt(1, r).withArrayAt(20, r).build(), 67000, 150000},
            {testCase().withArrayAt(0, r)
                    .withArrayAt(1, r)
                    .withArrayAt(2, r)
                    .withBitmapAt(200, r)
                    .withRunAt(205, r).build(), 199 * (1 << 16), 200 * (1 << 16) + (1 << 14)},
    };
  }
